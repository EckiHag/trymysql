...
npx create-next-app@latest codealongwithsmilga
```

cd codealongwithsmilga
answering questions only tailwind yes and app routing yes
...
Eine Variable markieren und dann Str F2, dann werden alle gleichen Namens markiert.
